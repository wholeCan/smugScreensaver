    ...
    class Program
    {
        ...
        private static void GetSmugMugSecrets()
        {
            ...
            if (string.IsNullOrEmpty(apiKey) || string.IsNullOrEmpty(secret))
            {
                ...
                apiKey = "TflvkBWIC1j26vLhO2GDLn7Lv6WrfdWn";
                secret = "9ecd2a3c4348e319c481f28d23b2941e";
            ...
            Console.WriteLine("This app is establishing the connection to your account.\nA web browser should open, enter your credentials and then close the browser.\n\n");
       //     Console.WriteLine("Using APIKey={0}", apiKey);
         //   Console.WriteLine("Using AppSecret={0}", secret);  //HIDE THE SECRETS!
      //      Console.WriteLine("Using token={0}", token);
        ...
        static void Main(string[] args)
        {
            ...
            // string d = "Hello";
            // SmugMugSecretsAccess.EncryptTextToFile(d, @"C:\Users\aholk\AppData\Local\Temp\andy.dat", null, null);
            //  SmugMugSecretsAccess.SaveSecretsToFile("a", "b", "c", "d");
            //  SmugMugSecretsAccess.ReadSecretsFromFile(out s)
            // var resut = SmugMugSecretsAccess.DecryptTextFromFile(@"C:\Users\aholk\AppData\Local\Temp\smugmug.dat", null, null);

            //Console.WriteLine(d + " ==> " + resut.ToString());
